DROP DATABASE IF EXISTS examen_pt4;
CREATE DATABASE IF NOT EXISTS examen_pt4 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE examen_pt4;
...
GRANT ALL PRIVILEGES  on examen_pt4.* TO 'user'@'localhost';
