...
select nombre, peso from paso where peso BETWEEN 1800 and 2200;
...
select nombre, barrio from procesion where hora_inicio > "19:00:00" and barrio = "Realejo";
